...
```text
src/                     Web editor and current KMD runtime source
...
public/                  Samples, fixtures, fonts, and static assets
scripts/                 Local scripts
```

Future structure may introduce `apps/` and `packages/`, but large directory moves are intentionally postponed until the runtime boundaries are more stable.
